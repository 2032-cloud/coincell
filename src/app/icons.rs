//! Codepoints for the [Phosphor](https://phosphoricons.com) icon glyphs.
//!
//! The font itself is registered by [`super::fonts`]; these are just the
//! private-use chars to render with it. Add more from phosphoricons.com as
//! needed (the value is the char in the "Regular" weight).
